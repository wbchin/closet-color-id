...
class DataPopulation: ObservableObject {
  ...
  func createArticle() {
    ...
    viewModel.setComplimentaryColor(article: article2!, complimentary_color_family: "red", complimentary_color_name: "skin")
    ...
    viewModel.setComplimentaryColor(article: article3!, complimentary_color_family: "red", complimentary_color_name: "skin")
